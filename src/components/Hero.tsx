...
const Hero = () => {
  ...
  return (
    <section className={`min-h-screen flex items-center justify-center relative overflow-hidden ${darkMode
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="grid grid-cols-12 gap-4 h-full w-full">
            {Array.from({ length: 100 }).map((_, i) => (
              <div
                key={i}
                className={`${Math.random() > 0.5 ? 'opacity-20' : 'opacity-10'
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <div className={`text-xl md:text-2xl font-light mb-8 ${darkMode ? 'text-blue-300' : 'text-blue-600'
            }`}>
          ...
          <p className={`max-w-2xl mx-auto text-lg mb-10 ${darkMode ? 'text-gray-300' : 'text-gray-600'
            }`}>
            Mobile developer with 4+ yrs experience building scalable, high-performance apps with Kotlin, Java, and Flutter.
          </p>

          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="#about"
              className={`px-8 py-3 rounded-full font-medium transition-all ${darkMode
